...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"src/js/window.js":[function(require,module,exports) {
"use strict";
...
var Window = /*#__PURE__*/function () {
  function Window(el, initX, initY) {
    var _this = this;

    _classCallCheck(this, Window);

    console.log('init Window', el);
    this.el = el;
    var height = 300;
    var width = 300;
  ...
  _createClass(Window, [{
    ...
    value: function setWindowPosition() {
      ...
      this.el.style.transform = "translate3d(".concat(this.posX, "px, ").concat(this.posY, "px, 0)");
    }
  }]);
...
var windowElements = document.querySelectorAll('.windows li');
console.log(windowElements);
var windowList = [];
window.maxZIndex = 0;
windowElements.forEach(function (el) {
  windowList.push(new _window.default(el));
});
...
},{"./js/window":"src/js/window.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
